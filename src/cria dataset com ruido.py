...
#     # 🔥 evita usar a pasta "ruido" como entrada
#     if label.lower() == "ruido":
#         continue
...
#             noisy_audio = augment_noise(audio)
#             features = extract_features(noisy_audio, sr)

#             row = {
#                 "original_path": file_path,  # 🔥 referência essencial
#                 "label": label,
#                 "tipo": "ruido"
#             }
